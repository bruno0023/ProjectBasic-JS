class ValidaFormulario {
  ...
  criaErro(campo, msg) {
    ...
    div.innerHTML = msg;
    div.classList.add('error-text'); // adiciona uma class na div
    campo.insertAdjacentElement('afterend', div); // Adiciona a div nesse caso no final do elemento que a chamou `afeterend`
  }
